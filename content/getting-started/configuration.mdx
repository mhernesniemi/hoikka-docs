...
When using the Vercel deploy button, `DATABASE_URL` and `BLOB_READ_WRITE_TOKEN` are provisioned automatically. Use `npx vercel env pull .env.local` to sync them locally.
