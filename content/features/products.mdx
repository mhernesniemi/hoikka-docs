...
Translations are edited in the admin panel via language tabs on the main form (`TranslationEditor.svelte`, shared by all translated entities). See [Localization](/core/localization) for details.
...
The storefront uses a SQLite FTS5 index instead — see [Search & Categories](/features/search-and-categories).
